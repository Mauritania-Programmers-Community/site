...
export function HeroMinimal() {
  ...
  const codeY = useTransform(scrollYProgress, [0, 1], [0, 100]);
      ...
      <div className="container relative mx-auto flex min-h-screen items-center px-4 py-20 lg:py-0">
        <div className="grid w-full gap-8 lg:grid-cols-2 lg:gap-16 xl:gap-24">
          ...
          >
            ...
            >
              <span className="inline-flex items-center gap-2 rounded-xl border border-mpc-green-500/30 bg-mpc-green-500/5 px-4 py-2 text-sm font-medium text-mpc-green-600 backdrop-blur-sm dark:text-mpc-green-400">
          ...
          >
            ...
            >
              ...
              <div className="absolute -end-8 -top-8 h-full w-full rounded-2xl border border-mpc-gold-500/10 bg-mpc-gold-500/5 sm:-end-12 sm:-top-12" />
