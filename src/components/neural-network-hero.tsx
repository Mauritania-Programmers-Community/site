...
// Type for our custom shader material uniforms
type CPPNShaderMaterialType = THREE.ShaderMaterial & {
  iTime: number;
...
function ShaderPlane() {
  ...
  // Using ShaderMaterial as base type since it's extended by shaderMaterial()
...
// Extend ThreeElements to include our custom shader material
